...
function retrieve(label, amount)
  ...
  if sort_slot ~= 0 then
    ...
    if amount > available then print("Warning! You have requested more than in the system, sending all available %s instead.", label) end
    while amount > 64 do
    ...
    print("Item %s not in system.", label)
  end
end
